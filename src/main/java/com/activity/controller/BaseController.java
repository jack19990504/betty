...
import com.activity.yaml.entity.Initialization;
import com.google.gson.Gson;

import com.activity.engine.entity.TrainFace;
import com.activity.engine.scenario.entity.TimeRecord;
import com.activity.engine.util.YamlUtil;
...
public class BaseController{	
	...
	protected static boolean init(){
    	...
    	INITIALIZATION =  yamlUtil.loadInitializationYaml("C:/Users/jack1/betty/demo/yaml/Initialization.yaml");
